        ...
        <section className="tab-page">
          <article className="card">
            ...
            <div className="balance-grid">
              <div className="balance-item balance-hero"><span className="balance-hero-label">{TXT.totalBalance}</span><strong className="balance-hero-amount" style={{ fontSize: "72px", lineHeight: 0.9, fontWeight: 700 }}>{formatCurrency(totalBalance)}</strong><p className="balance-hero-meta"><span className="balance-hero-meta-strong"><span className="balance-hero-arrow">↗</span> +{formatCurrency(totalIncomeCurrentMonth)}</span> {TXT.incomeThisMonth}</p></div>
